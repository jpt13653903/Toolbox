...
std::u32string& UTF_CONVERTER::UpperCase(const std::u32string& String){
  ...
  for(size_t n = 0; UTF_32[n]; n++){
    ...
    else if(UTF_32[n] == 0x00B5) UTF_32[n] += 743;
    ...
    else if(UTF_32[n] == 0x020B) UTF_32[n] -= 1;
    ...
    else if(UTF_32[n] == 0x04BB) UTF_32[n] -= 1;
    ...
    else if(UTF_32[n] == 0x1E83) UTF_32[n] -= 1;
    ...
    else if(UTF_32[n] == 0x2CD9) UTF_32[n] -= 1;
